...
from model_add_and_invert import model_add_and_invert


class test_add_and_invert:
    def __init__(self, dut):
        ...
        self.model = model_add_and_invert(int(self.dut.WIDTH))
...
@cocotb.test()
def add_and_invert_random_test(dut, num_tests=100):
    MAX_VALUE = 2 ** int(dut.WIDTH)

    tb = test_add_and_invert(dut)
